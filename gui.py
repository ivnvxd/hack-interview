...
def build_layout() -> (
    ...
    audio_source = sg.Combo(
        list(AUDIO_SOURCE_OPTIONS.keys()),
        default_value=DEFAULT_AUDIO_SOURCE_LABEL,
        readonly=True,
        k="-AUDIO_SOURCE_COMBO-",
        s=28,
        tooltip="System = Teams/Zoom call audio. Mic = your microphone only.",
    )
